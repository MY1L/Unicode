...
- 3000..CJK Symbols and Punctuation 　 　	；思源黑(64∕64字)
  - 2023-11-24 v9.6：参照[苏码字形修改提案](https://www.unicode.org/L2/L2023/23227-suzhou-nine-feedback.pdf)，改变了｢〢〦〧〨〩｣、自制了各种东亚标点和〾(自[CtrlCtrl]1.2)
...
- F900..CJK Compatibility Ideographs 　 　	；思源黑(366∕472字)
  ...
  - 2023-11-25 v9.6：[重新检查兼容汉字映射](https://www.unicode.org/charts/PDF/UF900.pdf "F900汉字兼容表意")，如｢䀹䀹鿃䀹｣……对128个与汉字同形的兼容字如｢樂樂樂樂｣附标小🅒以便区分。
